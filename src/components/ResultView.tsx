...
type RemarkFilter = 'all' | 'Match' | 'Amount Mismatch' | 'Reversal' | 'Not Booked in Brands Ledger' | 'Not Booked by Mars';
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-7">
        ...
        <Metric label="Not Booked in Brands Ledger" value={stats.mars_not_booked_by_brand} tone="warn" />
...
function RemarksFilter({
  ...
  const opts: RemarkFilter[] =
    side === 'mars'
      ? ['all', 'Match', 'Amount Mismatch', 'Not Booked in Brands Ledger']
...
function rowClass(_r: Row): string {
  return '';
}
